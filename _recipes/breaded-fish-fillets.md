...
ingredients:
  ...
  - { qty: "1/2 cup", item: "Bread crumbs or crushed crackers" }
  - { qty: "1/2 cup", item: "Grated parmesan cheese" }
  - { qty: "1", item: "Medium egg" }
equipment:
  - { type: "", item: "Air fryer" }
  - { type: "2", item: "Prison plates" }
  - { type: "1 Medium", item: "bowl" }
ingredientsYouHave:
  - Salt
  - Pepper
